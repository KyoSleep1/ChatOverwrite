package dev.sleep.chatoverwrite.client.chat;
...
import dev.sleep.chatoverwrite.common.network.packet.PacketNotifyMessageDelete;
import dev.sleep.chatoverwrite.mixin.client.MinecraftAccessor;
